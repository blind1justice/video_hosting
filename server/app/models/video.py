...
from sqlalchemy import ForeignKey, Integer, Text, String, Enum, text
...
class Video(Base):
    ...
    status: Mapped[VideoStatus] = mapped_column(Enum(VideoStatus), server_default=VideoStatus.PROCESSING.name)
